...
Build the non-anonymous WMT26 camera-ready paper with:
...
The camera-ready paper uses the official ACL style and reports both the controlled local evidence and released WMT26 blind-test/H100 results. It explicitly distinguishes organizer host-RSS reporting from GPU VRAM and records the unmatched FP4/NF4 ablation as a limitation.
